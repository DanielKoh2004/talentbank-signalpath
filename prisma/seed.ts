  ...
  await prisma.matchScore.create({
    data: {
      ...
      matrixJson: JSON.stringify({
        skills: {
          sql: { required: true, evidenceStrength: 4, met: true },
          data_visualization: { required: true, evidenceStrength: 4, met: true },
          product_analytics: { required: true, evidenceStrength: 0, met: false },
          ab_testing: { required: true, evidenceStrength: 0, met: false },
          stakeholder_communication: { required: true, evidenceStrength: 3, met: true },
          data_analysis: { required: false, evidenceStrength: 4, met: true },
          python_data: { required: false, evidenceStrength: 3, met: true },
        },
        gaps: ["product_analytics", "ab_testing"],
        strengths: ["sql", "data_visualization", "data_analysis"],
      }),
